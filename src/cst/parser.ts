...
export class Parser {
  ...
  private execLiteral(
    expr: { type: "Literal"; value: string },
    ctx: Context,
  ): CST | null {
  ...
  private execRegExp(
    expr: { type: "RegExpMatch"; pattern: string },
    ctx: Context,
  ): CST | null {
  ...
  private execSequence(
    expr: { type: "Sequence"; expressions: Expression[] },
    ctx: Context,
  ): CST | null {
  ...
  private execChoice(
    expr: { type: "Choice"; expressions: Expression[] },
    ctx: Context,
  ): CST | null {
    for (const childExpr of expr.expressions) {
      const startPos = ctx.pos;
  ...
  private execRepeat(
    expr: { type: "Repeat"; expression: Expression; min: number; max: number },
    ctx: Context,
  ): CST | null {
    const startPos = ctx.pos;
    const children: CST[] = [];
  ...
  private execExclusion(
    expr: { type: "Exclusion"; a: Expression; b: Expression },
    ctx: Context,
  ): CST | null {
    const startPos = ctx.pos;
  ...
  private execReference(
    expr: { type: "Reference"; name: string },
    ctx: Context,
  ): CST | null {
