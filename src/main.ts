...
try {
  ...
  if (api.ast) {
    ...
    titles.forEach((title) => {
      ...
      if (title.cst) {
        console.log(
          `  -> Source location: start=${title.cst.start}, end=${title.cst.end}`,
        );
      }
    });
    ...
    if (targetSection) {
      ...
      if (targetSection.cst) {
        console.log(
          `Updated Section Location: start=${targetSection.cst.start}, end=${targetSection.cst.end}`,
        );
        console.log("Updated Content:");
        console.log(
          api.input.slice(targetSection.cst.start, targetSection.cst.end),
        );
      } else {
